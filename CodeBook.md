...
1. Download, unzip, save, and loads necessary files into workspace.  The files needed for this tidy set as described in the README.md.  The files are read as table format and data frames are created from them. 
```
